...
def main() :
    params = {'N': 10, 'd': 100, 'mu': 0.0, 'L': 1.0, 'R': 1.0, 'K_max': 10, 'K': 0, 't': 1/1.0}
    K_max = 15
    ...
    for K in range(K_max) :
        for algorithm in [gradient_descent, nesterov_accelerated_gradient] :
            ...
            dict_name = f'result/preconditioner/{function_class.__name__}/Expectation/{algorithm.__name__}_K{params['K']}_over_{params['K_max']}.npy'
