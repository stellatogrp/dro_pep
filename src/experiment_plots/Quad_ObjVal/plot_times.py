...
def plot_times():
    ...
    final_columns = ['algorithm', 'K', 'worst-case (PEP)', 'expectation']
    ...
    time_cols = ['worst-case (PEP)', 'expectation']
    ...
    df_final.to_csv('times_quad_mp_comp.csv', index=False, float_format='%.6f')
