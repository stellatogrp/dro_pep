...
ISTA_exp_dro = pd.read_csv('test/dro/ISTA_exp_1_20/dro.csv')
ISTA_cvar_dro = pd.read_csv('test/dro/ISTA_cvar_1_20/dro.csv')
FISTA_exp_dro = pd.read_csv('test/dro/FISTA_exp_1_20/dro.csv')
FISTA_cvar_dro = pd.read_csv('test/dro/FISTA_cvar_1_20/dro.csv')
OptISTA_exp_dro = pd.read_csv('test/dro/OptISTA_exp_1_20/dro.csv')
OptISTA_cvar_dro = pd.read_csv('test/dro/OptISTA_cvar_1_20/dro.csv')
...
def main_bounds():
    ...
    ISTA_cvar_dro_eps = ISTA_cvar_dro[ISTA_cvar_dro['eps_idx'] == 2]
    FISTA_exp_dro_eps = FISTA_exp_dro[FISTA_exp_dro['eps_idx'] == 2]
    FISTA_cvar_dro_eps = FISTA_cvar_dro[FISTA_cvar_dro['eps_idx'] == 2]
    OptISTA_exp_dro_eps = OptISTA_exp_dro[OptISTA_exp_dro['eps_idx'] == 2]
    OptISTA_cvar_dro_eps = OptISTA_cvar_dro[OptISTA_cvar_dro['eps_idx'] == 2]
    ...
    ax[2].plot(range(1, exp_K_max + 1), OptISTA_exp_k, label='Sample OptISTA', linestyle='--', color=OptISTA_color)
    ax[2].plot(range(1, exp_K_max + 1), OptISTA_exp_dro_eps['dro_feas_sol'][:exp_K_max], color=OptISTA_color)
