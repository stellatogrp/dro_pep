...
#SBATCH --array=0-1
#SBATCH -o /scratch/gpfs/BSTELLATO/bs37/cert_dro_pep_out/Quad/runs/%A_%a.txt
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT
#SBATCH --mail-user=bs37@princeton.edu

# Quad certification PEP stage: 2 tasks (grad_desc, nesterov_fgm).
...
cd "$REPO/src"
python run_pep_experiment.py Quad cluster
