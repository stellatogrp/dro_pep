...
#SBATCH --array=0-1
#SBATCH -o /scratch/gpfs/BSTELLATO/bs37/cert_dro_pep_out/Lasso/runs/%A_%a.txt
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT
#SBATCH --mail-user=bs37@princeton.edu

# Lasso certification PEP stage: 2 tasks (grad_desc, nesterov_fgm).
# One PEPit solve per K; light.
...
cd "$REPO/src"
python run_pep_experiment.py Lasso cluster
